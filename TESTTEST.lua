...
do
    ...
    coroutine.wrap(preventAFK)()

    -- สำหรับฟีเจอร์ AutoCollect
    ...
    coroutine.wrap(autoDropLoot)()

    -- สำหรับฟีเจอร์ AutoFarmMob
    ...
    coroutine.wrap(autoFarmMob)()

    -- สำหรับฟีเจอร์ AutoFarmBoss
